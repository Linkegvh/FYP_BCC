...
HD_PWD='C:/Users/Lingke/Desktop/FYP/Round 1 Prototype/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log State_control.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source State_control.tcl -notrace
