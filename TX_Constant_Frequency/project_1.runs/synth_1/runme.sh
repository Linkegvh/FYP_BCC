...
HD_PWD='C:/Users/Lingke/Desktop/FYP/Round 1 Prototype/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log State_control.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source State_control.tcl
